...
namespace IdentitySecuredApp.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public LaptopsController(MyIdentityDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,ImageUrl")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,ImageUrl")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
